layui.use(['table', 'utilFn', 'conf', 'laydate', 'jquery'], function () {
    ...
    var config = {
        elem: '#regularOrder',
        id: 'regularOrder',
        url: conf.basePath + conf.regularlist,
        method: 'POST',
        even: true,
        where: {
        ...
        cols: [
            ...
            if (window.top !== window.self) {
                window.parent.document.getElementById("regularOrder").height = 0;
                window.parent.document.getElementById("regularOrder").height = 382;
            };
            if (res.code == -1) {
    ...
    var vm = new Vue({
        ...
        methods: {
            research: function () {
                ...
                table.reload('regularOrder', config);
            },
            reset: function () {
                $('#buyStartTime').val('');
                $('#buyEndTime').val('');
