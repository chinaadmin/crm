layui.use(['table', 'utilFn', 'conf', 'laydate', 'jquery'], function () {
    ...
    var config = {
        elem: '#pledgeBOrder',
        id: 'pledgeBOrder',
        url: conf.basePath + conf.stabilizelist,
        method: 'POST',
        even: true,
        where: {
        ...
        cols: [
            ...
            if (window.top !== window.self) {
                window.parent.document.getElementById("pledgeBOrder").height = 0;
                window.parent.document.getElementById("pledgeBOrder").height = 382;
            };
            if (res.code == -1) {
    ...
    var vm = new Vue({
        ...
        methods: {
            research: function () {
                ...
                table.reload('pledgeBOrder', config);
            },
            reset: function () {
                $('#buyStartTime').val('');
                $('#buyEndTime').val('');
