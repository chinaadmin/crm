layui.use(['conf', 'utilFn', 'layer', 'laydate', 'table'], function() {
  ...
  var config = {
    elem: '#dataTable',
    id: 'dataTable',
    url: conf.basePath + conf.selectBuyRemindingData,
    method: 'POST',
    where: {
    ...
    cols: [
      [
        ...
        { field: 'productType', title: '购买产品', width: 100, align: 'center', templet: '#tp3' },
        { field: 'buyGram', title: '购买克重', width: 100, align: 'center', sort: true },
        { field: 'buyPrice', title: '购买金价', width: 100, align: 'center', sort: true },
        { field: 'buyAmount', title: '购买金额', width: 100, align: 'center', sort: true },
        { field: 'amountPayment', title: '支付金额', width: 100, align: 'center', sort: true },
        { field: 'payTime', title: '支付成功时间', width: 100, align: 'center' },
        { field: 'beginInterestDate', title: '起息日期', width: 100, align: 'center' },
        { field: 'teamName', title: '组别', width: 100, align: 'center' },
        { field: 'salesName', title: '电销员', width: 100, align: 'center' },
        { field: 'lastFollowTime', title: '最近回访时间', width: 100, align: 'center' },
      ]
    ],
      ...
      if (count > 0) {
        var totalHtml = `<tr>
          <td class="text-center" colspan="7">合计(共${count}条)</td>
  ...
  table.on('tool(dataTable)', function(obj) {
    ...
    if (data.status == '0') {
      ...
      var param = { id: data.id, updatePageType: '5' }
