layui.use(['conf', 'utilFn', 'layer', 'laydate', 'table'], function() {
  ...
  var config = {
    elem: '#dataTable',
    id: 'dataTable',
    url: conf.basePath + conf.selectCapitalInflowReminderData,
    method: 'POST',
    where: {
    ...
    cols: [
      [
        ...
        { field: 'amount', title: '金额', width: 150, align: 'center', sort: true },
        { field: 'payTime', title: '资金流入时间', width: 180, align: 'center' },
  ...
  table.on('tool(dataTable)', function(obj) {
    ...
    if (data.status == '0') {
      ...
      var param = { id: data.id, updatePageType: '1' }
