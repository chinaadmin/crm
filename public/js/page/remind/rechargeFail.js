layui.use(['conf', 'utilFn', 'layer', 'laydate', 'table'], function() {
  ...
  var config = {
    elem: '#dataTable',
    id: 'dataTable',
    url: conf.basePath + conf.selectRechargeFailureRemindingData,
    method: 'POST',
    where: {
    ...
    cols: [
      [
        ...
        { field: 'bankName', title: '所属银行', width: 150, align: 'center' },
        { field: 'amount', title: '充值金额', width: 180, align: 'center', sort: true },
        { field: 'paymentTime', title: '充值时间', width: 180, align: 'center' },
        { field: 'returnCode', title: '失败代码', width: 120, align: 'center' },
        { field: 'returnMsg', title: '失败描述', width: 180, align: 'center' },
        { field: 'teamName', title: '组别', width: 150, align: 'center' },
        { field: 'salesName', title: '电销员', width: 150, align: 'center' },
  ...
  table.on('tool(dataTable)', function(obj) {
    ...
    if (data.status == '0') {
      ...
      var param = { id: data.id, updatePageType: '7' }
